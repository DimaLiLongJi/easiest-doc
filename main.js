...
"use strict";var t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},e=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var r=e(require("../Utils")),o=function(){function e(t,e,o){this.data=t,this.watcher=e,this.render=o,this.watchData(this.data),this.utils=new r.default}return e.prototype.watchData=function(e){if(e&&"object"===(void 0===e?"undefined":t(e))){var r=this,o=function(t){var o=e[t];r.watchData(o),Object.defineProperty(e,t,{configurable:!0,enumerable:!0,get:function(){return o},set:function(t){var e;r.utils.isEqual(t,o)||(r.watcher&&(e=JSON.parse(JSON.stringify(r.data))),o=t,r.watchData(o),r.watcher&&r.watcher(e),r.render&&r.render())}})};for(var n in e)o(n)}},e}();exports.default=o;
},{"../Utils":"H8Ea"}],"9pTu":[function(require,module,exports) {
"use strict";var t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},e=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var o=e(require("../Utils")),i=function(){function e(t,e,i){this.data=t,this.key=e,this.watcher=i,this.utils=new o.default,this.watchData(this.data,this.key)}return e.prototype.watchData=function(e,o){if(e&&"object"===(void 0===e?"undefined":t(e))&&e[o]){var i=this,n=e[o];Object.defineProperty(e,o,{configurable:!0,enumerable:!0,get:function(){return n},set:function(e){var o;i.utils.isEqual(e,n)||(i.watcher&&("object"===(void 0===n?"undefined":t(n))&&(o=JSON.parse(JSON.stringify(n))),"object"!==(void 0===n?"undefined":t(n))&&"function"!=typeof n&&(o=n)),n=e,i.watcher&&i.watcher(o))}})}},e}();exports.default=i;
},{"../Utils":"H8Ea"}],"Wip4":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){return function(e){this.tagName=e.tagName,this.node=e.node,this.parentNode=e.parentNode,this.attributes=e.attributes,this.childNodes=e.childNodes,this.nodeValue=e.nodeValue,this.type=e.type,this.value=e.value,this.repeatData=e.repeatData,this.eventTypes=e.eventTypes,this.key=e.key,this.checked=!1}}();function n(e){return 1===e.nodeType?"element":3===e.nodeType?"text":11===e.nodeType?"document-fragment":""}function t(e){var n=e.attributes,t=[];return n&&Array.from(n).forEach(function(e){t.push({name:e.name,value:e.value})}),t}function a(o){var d=[];return o.childNodes&&Array.from(o.childNodes).forEach(function(e){d.push(a(e))}),new e({tagName:o.tagName,node:o,parentNode:o.parentNode,attributes:t(o),childNodes:d,nodeValue:o.nodeValue,type:n(o),value:o.value,repeatData:o.repeatData?o.repeatData:null,eventTypes:o.eventTypes?o.eventTypes:null,key:o.indiv_repeat_key?o.indiv_repeat_key:null})}function o(e,n,t){e.childNodes.length>0&&e.childNodes.forEach(function(a,o){if(!a.checked){var d=n.childNodes.find(function(e){return e.node.isEqualNode(a.node)&&e.key===a.key&&!e.checked||e.tagName===a.tagName&&e.key===a.key&&!e.checked});if(d){var u=n.childNodes.findIndex(function(e){return e===d});u!==o&&t.push({type:1,newIndex:u,oldVnode:a.node,parentNode:e.node}),c(a,d,t),d.checked=!0}else t.push({type:0,node:a.node,parentNode:e.node});a.checked=!0}}),n.childNodes.length>0&&n.childNodes.forEach(function(n,a){n.checked||(t.push({type:1,newIndex:a,oldVnode:n.node,parentNode:e.node}),n.checked=!0)})}function d(e,n,t){n.attributes.forEach(function(n){var a=e.attributes.find(function(e){return e.name===n.name});a&&a.value===n.value||t.push({type:2,node:e.node,newValue:n,oldValue:a})}),e.attributes.forEach(function(a){n.attributes.find(function(e){return e.name===a.name})||t.push({type:3,node:e.node,oldValue:a})})}function u(e,n,t){e.nodeValue!==n.nodeValue&&t.push({type:4,node:e.node,newValue:n.nodeValue,oldValue:e.nodeValue})}function r(e,n,t){e.value!==n.value&&t.push({type:5,node:e.node,newValue:n.value,oldValue:e.value})}function l(e,n,t){t.push({type:6,node:e.node,newValue:n.repeatData})}function i(e,n,t){var a=JSON.parse(e.eventTypes),o=JSON.parse(n.eventTypes);o&&o.length>0&&o.forEach(function(a){t.push({type:7,node:e.node,eventType:a,newValue:n.node["event"+a]})}),a&&a.length>0&&a.forEach(function(n){(!o||o.length<=0)&&t.push({type:7,node:e.node,eventType:n,newValue:null}),o&&o.length>0&&!o.find(function(e){return e===n})&&t.push({type:7,node:e.node,eventType:n,newValue:null})}),t.push({type:8,node:e.node,newValue:n.eventTypes})}function c(e,n,t){t?"document-fragment"!==n.type?(d(e,n,t),u(e,n,t),"INPUT"!==e.tagName&&"TEXTAREA textarea"!==e.tagName&&"INPUT"!==e.tagName||r(e,n,t),l(e,n,t),i(e,n,t),o(e,n,t)):o(e,n,t):console.error("patchList can not be null, diffVnode must need an Array")}function p(e){e.sort(function(e,n){return e.type===n.type&&e.newIndex&&n.newIndex?e.newIndex-n.newIndex:e.type-n.type}),e.forEach(function(e){switch(e.type){case 0:e.parentNode.removeChild(e.node);break;case 1:Array.from(e.parentNode.children).indexOf(e.oldVnode)!==e.newIndex&&(e.parentNode.contains(e.oldVnode)&&e.parentNode.removeChild(e.oldVnode),e.parentNode.childNodes[e.newIndex]?e.parentNode.insertBefore(e.oldVnode,e.parentNode.childNodes[e.newIndex]):e.parentNode.appendChild(e.oldVnode));break;case 2:e.node.setAttribute(e.newValue.name,e.newValue.value);break;case 3:e.node.removeAttribute(e.oldValue.name);break;case 4:e.node.nodeValue=e.newValue;break;case 5:e.node.value=e.newValue;break;case 6:e.node.repeatData=e.newValue;break;case 7:e.node["on"+e.eventType]=e.newValue;break;case 8:e.node.eventTypes=e.newValue}})}var s={parseToVnode:a,diffVnode:c,renderVnode:p};exports.default=s;
},{}],"bsu5":[function(require,module,exports) {
"use strict";var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(e){this.$fragment=e}return t.prototype._getValueByValue=function(e,t,r){var n=t.replace("()","").split("."),a=e;return n.forEach(function(e,t){e===r&&0===t||(a=a[e])}),a},t.prototype._setValueByValue=function(e,t,r,n){var a,i=t.replace("()","").split("."),o=e;i.forEach(function(e,t){if(e===r&&0===t)return a=e;t<i.length&&(a=e),t<i.length-1&&(o=o[e])}),a&&(o[a]=n)},t.prototype._getVMVal=function(e,t){var r=t.replace("()","").split("."),n=e;return r.forEach(function(e){n=n[e]}),n},t.prototype._getVMRepeatVal=function(e,t,r){var n;return t.replace("()","").split(".").forEach(function(t,a){n=t!==r||0!==a?n[t]:e}),n},t.prototype.bind=function(e,t,r,n,a,i,o){var p,s,l=e.repeatData[t];p=0===n.indexOf(t)||0===n.indexOf(t+".")?this._getVMRepeatVal(l,n,t):this._getVMVal(i,n),s=0===n.indexOf(t)||0===n.indexOf(t+".")?o:this._getVMVal(i,n),e.hasChildNodes()||this.templateUpdater(e,l,t,i);var u=this[r+"Updater"];switch(r){case"model":u&&u.call(this,e,p,n,t,a,s,i);break;default:u&&u.call(this,e,p)}},t.prototype.templateUpdater=function(e,t,r,n){var a=e.textContent;if(/\{\{(.*)\}\}/g.test(a)){var i=a.match(/(\{\{[^\{\}]+?\}\})/g);if(i&&i.length>0)for(var o=0;o<i.length;o++){var p=i[o].replace("{{","").replace("}}",""),s=void 0;s=0===p.indexOf(r)||0===p.indexOf(r+".")?this._getVMRepeatVal(t,p,r):this._getVMVal(n,p),e.textContent=e.textContent.replace(i[o],s)}}},t.prototype.textUpdater=function(e,t){if("input"===e.tagName.toLocaleLowerCase())return e.value=t;e.textContent=void 0===t?"":t},t.prototype.htmlUpdater=function(e,t){e.innerHTML=void 0===t?"":t},t.prototype.ifUpdater=function(e,t){!t&&this.$fragment.contains(e)&&this.$fragment.removeChild(e)},t.prototype.classUpdater=function(e,t,r){if(t||r){var n=e.className,a=(n=n.replace(r,"").replace(/\s$/,""))&&String(t)?" ":"";e.className=n+a+t}},t.prototype.modelUpdater=function(t,r,n,a,i,o,p){t.value=void 0===r?"":r;var s=this,l=function(t){if(t.preventDefault(),/(state.).*/.test(n)){var r=n.replace(/(state.)/,"");if(t.target.value===o)return;p.state[r]=t.target.value}if((0===n.indexOf(a)||0===n.indexOf(a+"."))&&("object"!==e(o[i])&&(o[i]=t.target.value),"object"===e(o[i]))){var l=s._getValueByValue(o[i],n,a);l=t.target.value,s._setValueByValue(o[i],n,a,l)}};if(t.oninput=l,t.eventinput=l,t.eventTypes){var u=JSON.parse(t.eventTypes);u.push("input"),t.eventTypes=JSON.stringify(u)}t.eventTypes||(t.eventTypes=JSON.stringify(["input"]))},t.prototype.keyUpdater=function(e,t){e.indiv_repeat_key=t},t.prototype.eventHandler=function(e,t,r,n,a,i){var o=n.split(":")[1],p=r.replace(/^(\@)/,"").replace(/\(.*\)/,"").split("."),s=r.replace(/^(\@)/,"").match(/\((.*)\)/)[1].replace(/ /g,"").split(","),l=t;p.forEach(function(e){l=l[e]});var u=this,f=function(r){var n=this,o=[];s.forEach(function(p){return""!==p&&("$event"===p?o.push(r):"$element"===p?o.push(e):/(state.).*/g.test(p)?o.push(u._getVMVal(t,p)):/\'.*\'/g.test(p)?o.push(p.match(/\'(.*)\'/)[1]):!/\'.*\'/g.test(p)&&/^[0-9]*$/g.test(p)?o.push(Number(p)):"true"===p||"false"===p?o.push("true"===p):0===p.indexOf(a)||0===p.indexOf(a+".")?o.push(u._getVMRepeatVal(i,p,a)):void(n.repeatData&&Object.keys(n.repeatData).forEach(function(e){if(0===p.indexOf(e)||0===p.indexOf(e+"."))return o.push(u._getValueByValue(n.repeatData[e],p,e))})))}),l.apply(t,o)};if(o&&l){if(e["on"+o]=f,e["event"+o]=f,e.eventTypes){var c=JSON.parse(e.eventTypes);c.push(o),e.eventTypes=JSON.stringify(c)}e.eventTypes||(e.eventTypes=JSON.stringify([o]))}},t}();exports.CompileUtilForRepeat=t;var r=function(){function e(e){this.$fragment=e}return e.prototype._getValueByValue=function(e,t,r){var n=t.replace("()","").split("."),a=e;return n.forEach(function(e,t){e===r&&0===t||(a=a[e])}),a},e.prototype._getVMVal=function(e,t){var r=t.replace("()","").split("."),n=e;return r.forEach(function(e,t){n=n[e]}),n},e.prototype._getVMRepeatVal=function(e,t){var r=t.split(" ");return this._getVMVal(e,r[3])},e.prototype.bind=function(e,t,r,n){var a=this[n+"Updater"];if(this.isRepeatNode(e))switch(n){case"repeat":a&&a.call(this,e,this._getVMRepeatVal(t,r),r,t)}else switch(n){case"model":a&&a.call(this,e,this._getVMVal(t,r),r,t);break;case"text":a&&a.call(this,e,this._getVMVal(t,r));break;case"if":a&&a.call(this,e,this._getVMVal(t,r),r,t);break;default:a&&a.call(this,e,this._getVMVal(t,r))}},e.prototype.templateUpdater=function(e,t,r){e.textContent=e.textContent.replace(r,this._getVMVal(t,r.replace("{{","").replace("}}","")))},e.prototype.textUpdater=function(e,t){if("input"===e.tagName.toLocaleLowerCase())return e.value=t;e.textContent=void 0===t?"":t},e.prototype.htmlUpdater=function(e,t){e.innerHTML=void 0===t?"":t},e.prototype.ifUpdater=function(e,t){!t&&this.$fragment.contains(e)&&this.$fragment.removeChild(e)},e.prototype.classUpdater=function(e,t,r){if(t||r){var n=e.className,a=(n=n.replace(r,"").replace(/\s$/,""))&&String(t)?" ":"";e.className=n+a+t}},e.prototype.modelUpdater=function(e,t,r,n){e.value=void 0===t?"":t;var a=r.replace(/(state.)/,""),i=function(e){e.preventDefault(),/(state.).*/.test(r)&&(n.state[a]=e.target.value)};if(e.oninput=i,e.eventinput=i,e.eventTypes){var o=JSON.parse(e.eventTypes);o.push("input"),e.eventTypes=JSON.stringify(o)}e.eventTypes||(e.eventTypes=JSON.stringify(["input"]))},e.prototype.repeatUpdater=function(e,r,n,a){var i=this;if(r)if(!r||r instanceof Array){var o=n.split(" ")[1];r.forEach(function(p,s){var l={};l[o]=p,l.$index=s;var u=i.cloneNode(e,l),f=u.attributes,c=u.textContent;i.$fragment.insertBefore(u,e),u.removeAttribute("nv-repeat"),i.isTextNode(u)&&/\{\{(.*)\}\}/g.test(c)&&new t(i.$fragment).templateUpdater(u,p,o,a),f&&Array.from(f).forEach(function(e){var n=e.name;if(i.isDirective(n)&&"nv-repeat"!==n){var l=n.substring(3),f=e.value;i.isEventDirective(l)?new t(i.$fragment).eventHandler(u,a,f,l,o,p):new t(i.$fragment).bind(u,o,l,f,s,a,r),u.removeAttribute(n)}}),u.hasChildNodes()&&i.$fragment.contains(u)&&i.repeatChildrenUpdater(u,p,n,s,a,r)})}else console.error("compile error: nv-repeat need an Array!")},e.prototype.repeatChildrenUpdater=function(r,n,a,i,o,p){var s=this,l=a.split(" ")[1];Array.from(r.childNodes).forEach(function(u){u.repeatData=r.repeatData||{},u.repeatData[l]=n,u.repeatData.$index=i,s.isRepeatProp(u)&&u.setAttribute("_prop-"+l,JSON.stringify(n));var f=u.attributes,c=u.textContent;s.isTextNode(u)&&/\{\{(.*)\}\}/g.test(c)&&new t(r).templateUpdater(u,n,l,o),f&&Array.from(f).forEach(function(e){var a=e.name,f=e.value,c=a.substring(3);s.isDirective(a)&&"nv-repeat"!==a&&new RegExp("(^"+l+")|(^state)|(^@)").test(f)&&(s.isEventDirective(c)?new t(r).eventHandler(u,o,f,c,l,n):new t(r).bind(u,l,c,f,i,o,p),u.removeAttribute(a))}),u.hasChildNodes()&&!s.isRepeatNode(u)&&r.contains(u)&&s.repeatChildrenUpdater(u,n,a,i,o,p);var v=u.attributes;if(v&&r.contains(u)){var d=Array.from(v).find(function(e){return s.isDirective(e.name)&&"nv-repeat"===e.name});if(d){var y=d.value.split(" ")[3];/^(state\.)/.test(y)&&(new e(r).bind(u,o,d.value,d.name.substring(3)),r.contains(u)&&r.removeChild(u)),new RegExp("(^"+l+")").test(y)&&(new e(r).repeatUpdater(u,s._getValueByValue(n,y,l),d.value,o),r.contains(u)&&r.removeChild(u)),r.removeAttribute("nv-repeat")}}})},e.prototype.isDirective=function(e){return 0===e.indexOf("nv-")},e.prototype.isEventDirective=function(e){return 0===e.indexOf("on")},e.prototype.isElementNode=function(e){return 1===e.nodeType},e.prototype.isRepeatNode=function(e){var t=e.attributes,r=!1;return t&&Array.from(t).forEach(function(e){"nv-repeat"===e.name&&(r=!0)}),r},e.prototype.isRepeatProp=function(e){var t=e.attributes;return!!t&&!!Array.from(t).find(function(e){return/^\{(.+)\}$/.test(e.value)})},e.prototype.isTextNode=function(e){return 3===e.nodeType},e.prototype.cloneNode=function(e,t){var r=e.cloneNode(!0);return e.eventTypes&&(JSON.parse(e.eventTypes).forEach(function(t){r["on"+t]=e["event"+t],r["event"+t]=e["event"+t]}),r.eventTypes=e.eventTypes),t&&(r.repeatData=t),r},e}();exports.CompileUtil=r;
},{}],"twql":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t=e(require("../VirtualDOM")),i=e(require("../Utils")),n=require("../CompileUtils"),r=function(){function e(e,n,r){if(this.utils=new i.default,this.$vm=n,this.$el=this.isElementNode(e)?e:document.querySelector(e),this.$el){if(this.$fragment=this.node2Fragment(),this.init(),r){var o=this.$fragment.querySelectorAll(this.$vm.$vm.$routeDOMKey)[0];o.parentNode.replaceChild(r,o)}var s=t.default.parseToVnode(this.$el),a=t.default.parseToVnode(this.$fragment),l=[];t.default.diffVnode(s,a,l),t.default.renderVnode(l),this.utils=null,this.$fragment=null,s=null,a=null,l=null}}return e.prototype.init=function(){this.compileElement(this.$fragment)},e.prototype.compileElement=function(e){var t=document.createElement("div");t.innerHTML=this.utils.formatInnerHTML(this.$vm.$template);var i=t.childNodes;this.recursiveDOM(i,e)},e.prototype.recursiveDOM=function(e,t){var i=this;Array.from(e).forEach(function(e){e.hasChildNodes()&&!i.isRepeatNode(e)&&i.recursiveDOM(e.childNodes,e),t.appendChild(e);var n=e.textContent;if(i.isElementNode(e)&&i.compile(e,t),i.isTextNode(e)&&/\{\{(.*)\}\}/g.test(n)){var r=n.match(/(\{\{(state\.)[^\{\}]+?\}\})/g);if(r&&r.length>0)for(var o=0;o<r.length;o++)i.compileText(e,r[o])}i.isRepeatNode(e)&&t.contains(e)&&t.removeChild(e)})},e.prototype.compile=function(e,t){var i=this,r=e.attributes;r&&Array.from(r).forEach(function(r){var o=r.name;if(i.isDirective(o)){var s=o.substring(3),a=r.value;i.isEventDirective(s)?i.eventHandler(e,i.$vm,a,s):new n.CompileUtil(t).bind(e,i.$vm,a,s)}})},e.prototype.node2Fragment=function(){return document.createDocumentFragment()},e.prototype.compileText=function(e,t){new n.CompileUtil(this.$fragment).templateUpdater(e,this.$vm,t)},e.prototype.eventHandler=function(e,t,i,r){var o=r.split(":")[1],s=i.replace(/^(\@)/,"").replace(/\(.*\)/,"").split("."),a=i.replace(/^(\@)/,"").match(/\((.*)\)/)[1].replace(/\s+/g,"").split(","),l=t;s.forEach(function(e){l=l[e]});var u=function(i){var r=[];a.forEach(function(o){return""!==o&&("$event"===o?r.push(i):"$element"===o?r.push(e):/(state.).*/g.test(o)?r.push((new n.CompileUtil)._getVMVal(t,o)):/\'.*\'/g.test(o)?r.push(o.match(/\'(.*)\'/)[1]):!/\'.*\'/g.test(o)&&/^[0-9]*$/g.test(o)?r.push(Number(o)):"true"===o||"false"===o?r.push("true"===o):void 0)}),l.apply(t,r)};if(o&&l){if(e["on"+o]=u,e["event"+o]=u,e.eventTypes){var p=JSON.parse(e.eventTypes);p.push(o),e.eventTypes=JSON.stringify(p)}e.eventTypes||(e.eventTypes=JSON.stringify([o]))}},e.prototype.isDirective=function(e){return 0===e.indexOf("nv-")},e.prototype.isEventDirective=function(e){return 0===e.indexOf("on")},e.prototype.isElementNode=function(e){return"string"!=typeof e&&1===e.nodeType},e.prototype.isRepeatNode=function(e){var t=e.attributes,i=!1;return t&&Array.from(t).forEach(function(e){"nv-repeat"===e.name&&(i=!0)}),i},e.prototype.isTextNode=function(e){return 3===e.nodeType},e}();exports.default=r;
...
"use strict";var t=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var e=t(require("../Compile")),o=t(require("../Watcher")),n=t(require("../Utils")),s=require("../CompileUtils"),r=require("../Injectable");function i(t){return function(i){i.$selector=t.selector;var a=i.prototype;a.$template=t.template,a.utils=new n.default,a.compileUtil=new s.CompileUtil,a.$components=[],a.$componentList=[],a.getLocation=function(){return this.utils.isBrowser()?{path:this.$vm.$esRouteObject.path,query:this.$vm.$esRouteObject.query,params:this.$vm.$esRouteParmasObject,data:this.$vm.$esRouteObject.data}:{}},a.setLocation=function(t,e,o,n){if(this.utils.isBrowser()){var s="/"===this.$vm.$rootPath?"":this.$vm.$rootPath;history.pushState({path:t,query:e,data:o},n,""+s+t+this.utils.buildQuery(e)),this.$vm.$esRouteObject={path:t,query:e,data:o}}},a.watchData=function(){this.state&&(this.nvWatchState&&(this.stateWatcher=new o.default(this.state,this.nvWatchState.bind(this),this.reRender.bind(this))),this.nvWatchState||(this.stateWatcher=new o.default(this.state,null,this.reRender.bind(this))))},a.render=function(){var t=this.renderDom;new e.default(t,this);this.mountComponent(t),this.$componentList.forEach(function(t){t.scope.render&&t.scope.render(),t.scope.nvAfterMount&&t.scope.nvAfterMount()}),this.nvHasRender&&this.nvHasRender()},a.reRender=function(){var t=this.renderDom,o=t.querySelectorAll(this.$vm.$routeDOMKey)[0];new e.default(t,this,o);this.mountComponent(t),this.$componentList.forEach(function(t){t.scope.render&&t.scope.reRender(),t.scope.nvAfterMount&&t.scope.nvAfterMount()}),this.nvHasRender&&this.nvHasRender()},a.mountComponent=function(t){var e=this,o=[];this.$componentList.forEach(function(t){o.push(t)}),this.componentsConstructor(t),this.$componentList.forEach(function(t){var n=o.find(function(e){return e.dom===t.dom});n&&(t.scope=n.scope,e.utils.isEqual(t.scope.props,t.props)||(t.scope.nvReceiveProps&&t.scope.nvReceiveProps(t.props),t.scope.props=t.props)),t.scope.$vm=e.$vm,t.scope.$components=e.$components,t.scope.nvOnInit&&!n&&t.scope.nvOnInit(),t.scope.watchData&&t.scope.watchData(),t.scope.nvBeforeMount&&t.scope.nvBeforeMount()})},a.componentsConstructor=function(t){var e=this;this.$componentList=[];var o=t.querySelectorAll(this.$vm.$routeDOMKey)[0];this.constructor._injectedComponents.forEach(function(t){e.$components.find(function(e){return e.$selector===t.$selector})||e.$components.push(t)});for(var n=function(n){var r=s.$components[n].$selector,i=t.getElementsByTagName(r);Array.from(i).forEach(function(t){if(!o||!o.contains(t)){var s=t.attributes,r={};if(s){var i=Array.from(s),a={};i.forEach(function(e){/^\_prop\-(.+)/.test(e.name)&&(a[e.name.replace("_prop-","")]=JSON.parse(e.value),t.removeAttribute(e.name))}),i.forEach(function(o){var n=o.name;if(!/^\_prop\-(.+)/.test(o.name)){var s=/^\{(.+)\}$/.exec(o.value);if(s){var i=s[1].split("."),c=i[0],p=null;if(/^(state.).*/g.test(s[1]))return p=e.compileUtil._getVMVal(e,s[1]),void(r[n]=e.buildProps(p));if(/^(\@.).*/g.test(s[1]))return p=e.compileUtil._getVMVal(e,s[1].replace(/^(\@)/,"")),void(r[n]=e.buildProps(p));if(a.hasOwnProperty(c))return p=e.getPropsValue(i,a[c]),void(r[n]=e.buildProps(p));if(t.repeatData&&null!==t.repeatData[c])return p=e.compileUtil._getValueByValue(t.repeatData[c],s[1],c),void(r[n]=e.buildProps(p))}"indiv_repeat_key"!==o.name&&t.removeAttribute(n)}})}e.$componentList.push({dom:t,props:r,scope:e.buildComponentScope(e.$components[n],r,t)})}})},s=this,r=0;r<=this.$components.length-1;r++)n(r)},a.setState=function(t){if(t&&this.utils.isFunction(t)){var e=t();if(e&&e instanceof Object){for(var o in e)this.state.hasOwnProperty(o)&&this.state[o]!==e[o]&&(this.state[o]=e[o]),this.state.hasOwnProperty(o)||(this.state[o]=e[o]);this.reRender()}}if(t&&t instanceof Object){for(var o in t)this.state.hasOwnProperty(o)&&this.state[o]!==t[o]&&(this.state[o]=t[o]),this.state.hasOwnProperty(o)||(this.state[o]=t[o]);this.reRender()}},a.getPropsValue=function(t,e){var o=e;return t.forEach(function(t,e){0!==e&&(o=o[t])}),o},a.buildProps=function(t){return this.utils.isFunction(t)?t.bind(this):t},a.buildComponentScope=function(t,e,o){var n=r.factoryCreator(t,this.$vm.$rootModule);return n.props=e,n.renderDom=o,n.$components=this.$components,n}}}exports.default=i;
...
"use strict";var t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},e=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var r=e(require("../Utils")),o=e(require("../KeyWatcher")),n=require("../types");exports.TRouter=n.TRouter;var i=function(){function e(){this.routes=[],this.routesList=[],this.currentUrl="",this.lastRoute=null,this.rootDom=null,this.utils=new r.default,this.$rootPath="/",this.hasRenderComponentList=[],this.needRedirectPath=null,this.$vm=null,this.watcher=null,this.renderRouteList=[]}return e.prototype.bootstrap=function(t){var e=this;this.$vm=t,this.$vm.setRootPath(this.$rootPath),this.$vm.$canRenderModule=!1,this.$vm.$routeDOMKey="router-render",this.utils.isBrowser()&&(window.addEventListener("load",this.refresh.bind(this),!1),window.addEventListener("popstate",function(){var t;t="/"===e.$rootPath?location.pathname||"/":""===location.pathname.replace(e.$rootPath,"")?"/":location.pathname.replace(e.$rootPath,""),e.$vm.$esRouteObject={path:t,query:{},data:null},e.$vm.$esRouteParmasObject={}},!1))},e.prototype.init=function(t){if(this.utils.isBrowser())if(t&&t instanceof Array){var e=document.querySelector("#root");this.rootDom=e||null,this.routes=t,this.routesList=[]}else console.error("route error: no routes exit")},e.prototype.setRootPath=function(t){t&&"string"==typeof t?this.$rootPath=t:console.error("route error: rootPath is not defined or rootPath must be a String")},e.prototype.redirectTo=function(t){var e="/"===this.$rootPath?"":this.$rootPath;history.replaceState(null,null,""+e+t),this.$vm.$esRouteObject={path:t||"/",query:{},data:null},this.$vm.$esRouteParmasObject={}},e.prototype.refresh=function(){if(!this.$vm.$esRouteObject||!this.watcher){var t=void 0;t="/"===this.$rootPath?location.pathname||"/":""===location.pathname.replace(this.$rootPath,"")?"/":location.pathname.replace(this.$rootPath,""),this.$vm.$esRouteObject={path:t,query:{},data:null},this.$vm.$esRouteParmasObject={},this.watcher=new o.default(this.$vm,"$esRouteObject",this.refresh.bind(this))}this.currentUrl=this.$vm.$esRouteObject.path||"/",this.routesList=[],this.renderRouteList="/"===this.currentUrl?["/"]:this.currentUrl.split("/"),this.renderRouteList[0]="/",this.distributeRoutes()},e.prototype.distributeRoutes=function(){this.lastRoute&&this.lastRoute!==this.currentUrl?(this.$vm.$esRouteParmasObject={},this.insertRenderRoutes()):this.generalDistributeRoutes(),this.routeChange&&this.routeChange(this.lastRoute,this.currentUrl),this.lastRoute=this.currentUrl,this.needRedirectPath&&(this.redirectTo(this.needRedirectPath),this.needRedirectPath=null)},e.prototype.insertRenderRoutes=function(){var e="/"===this.lastRoute?["/"]:this.lastRoute.split("/");e[0]="/";for(var r=function(t){var r=o.renderRouteList[t];if(0===t){var n=o.routes.find(function(t){return t.path===""+r||/^\/\:.+/.test(t.path)});if(!n)return console.error("route error: wrong route instantiation in insertRenderRoutes:",o.currentUrl),{value:void 0};o.routesList.push(n)}else{var i=o.routesList[t-1].children;if(!(i&&i instanceof Array))return console.error("route error: routes not exit or routes must be an array!"),{value:void 0};var s=i.find(function(t){return t.path==="/"+r||/^\/\:.+/.test(t.path)});if(!s)return console.error("route error: wrong route instantiation:",o.currentUrl),{value:void 0};o.routesList.push(s)}if(r!==e[t]){var u=o.routesList[t];if(!u)return console.error("route error: wrong route instantiation in insertRenderRoutes:",o.currentUrl),{value:void 0};var a=o.$vm.$components.find(function(t){return t.$selector===u.component}),h=document.querySelectorAll("router-render")[t-1];if(!u.component&&!u.redirectTo)return console.error("route error: path "+u.path+" need a component which has children path or need a  redirectTo which has't children path"),{value:void 0};if(/^\/\:.+/.test(u.path)&&!u.redirectTo){var c=u.path.split("/:")[1];o.$vm.$esRouteParmasObject[c]=r}if(a){var l=o.instantiateComponent(a,h);l&&(o.hasRenderComponentList[t]&&(o.hasRenderComponentList[t+1]=o.hasRenderComponentList[t],o.hasRenderComponentList[t]=l),o.hasRenderComponentList[t]||(o.hasRenderComponentList[t]=l)),o.routerChangeEvent(t)}if(u.redirectTo&&/^\/.*/.test(u.redirectTo)&&t+1===o.renderRouteList.length)return o.needRedirectPath=u.redirectTo,{value:void 0}}if(r===e[t]){var d=o.routesList[t];if(/^\/\:.+/.test(d.path)&&!d.redirectTo){c=d.path.split("/:")[1];o.$vm.$esRouteParmasObject[c]=r}}if(t===o.renderRouteList.length-1&&t<e.length-1){h=document.querySelectorAll("router-render")[t];if(o.routerChangeEvent(t),h&&h.hasChildNodes()&&h.removeChild(h.childNodes[0]),(d=o.routesList[t]).redirectTo&&/^\/.*/.test(d.redirectTo)&&t+1===o.renderRouteList.length)return o.needRedirectPath=d.redirectTo,{value:void 0}}},o=this,n=0;n<this.renderRouteList.length;n++){var i=r(n);if("object"===(void 0===i?"undefined":t(i)))return i.value}},e.prototype.generalDistributeRoutes=function(){for(var e=function(t){var e=r.renderRouteList[t];if(0===t){var o=r.routes.find(function(t){return t.path===""+e||/^\/\:.+/.test(t.path)});if(!o)return console.error("route error: wrong route instantiation in generalDistributeRoutes:",r.currentUrl),{value:void 0};var n=null;if(!r.$vm.$rootModule.$components.find(function(t){return t.$selector===o.component}))return console.error("route error: path "+o.path+" is undefined"),{value:void 0};if(n=r.$vm.$rootModule.$components.find(function(t){return t.$selector===o.component}),/^\/\:.+/.test(o.path)){var i=o.path.split("/:")[1];r.$vm.$esRouteParmasObject[i]=e}if(!r.utils.isBrowser())return{value:void 0};var s=document.querySelector("#root");if(r.routesList.push(o),(h=r.instantiateComponent(n,s))&&r.hasRenderComponentList.push(h),t===r.renderRouteList.length-1&&r.routerChangeEvent(t),o.redirectTo&&/^\/.*/.test(o.redirectTo)&&t+1===r.renderRouteList.length)return r.needRedirectPath=o.redirectTo,r.renderRouteList.push(o.redirectTo),{value:void 0}}else{var u=r.routesList[t-1].children;u&&u instanceof Array||console.error("route error: routes not exit or routes must be an array!");var a=u.find(function(t){return t.path==="/"+e||/^\/\:.+/.test(t.path)});if(!a)return console.error("route error: wrong route instantiation:",r.currentUrl),{value:void 0};n=null;if(r.$vm.$rootModule.$components.find(function(t){return t.$selector===a.component})&&(n=r.$vm.$rootModule.$components.find(function(t){return t.$selector===a.component})),!a.component&&!a.redirectTo)return console.error("route error: path "+a.path+" need a component which has children path or need a  redirectTo which has't children path"),{value:void 0};if(/^\/\:.+/.test(a.path)){i=a.path.split("/:")[1];r.$vm.$esRouteParmasObject[i]=e}var h,c=document.querySelectorAll("router-render")[t-1];if(r.routesList.push(a),n)(h=r.instantiateComponent(n,c))&&r.hasRenderComponentList.push(h);if(t===r.renderRouteList.length-1&&r.routerChangeEvent(t),a.redirectTo&&/^\/.*/.test(a.redirectTo)&&t+1===r.renderRouteList.length)return r.needRedirectPath=a.redirectTo,{value:void 0}}},r=this,o=0;o<this.renderRouteList.length;o++){var n=e(o);if("object"===(void 0===n?"undefined":t(n)))return n.value}},e.prototype.routerChangeEvent=function(t){var e=this;this.hasRenderComponentList.forEach(function(r,o){r.nvRouteChange&&r.nvRouteChange(e.lastRoute,e.currentUrl),e.emitComponentEvent(r.$componentList,"nvRouteChange"),o>=t+1&&(r.nvOnDestory&&r.nvOnDestory(),e.emitComponentEvent(r.$componentList,"nvOnDestory"))}),this.hasRenderComponentList.length=t+1},e.prototype.emitComponentEvent=function(t,e){var r=this;"nvRouteChange"===e&&t.forEach(function(t){t.scope.nvRouteChange&&t.scope.nvRouteChange(r.lastRoute,r.currentUrl),r.emitComponentEvent(t.scope.$componentList,e)}),"nvOnDestory"===e&&t.forEach(function(t){t.scope.nvOnDestory&&t.scope.nvOnDestory(),r.emitComponentEvent(t.scope.$componentList,e)})},e.prototype.instantiateComponent=function(t,e){return this.$vm.renderComponent(t,e)},e}();exports.Router=i;
