...
"use strict";var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(e){this.$fragment=e}return t.prototype._getValueByValue=function(e,t,a){var r=t.replace("()","").split("."),n=e;return r.forEach(function(e,t){e===a&&0===t||(n=n[e])}),n},t.prototype._setValueByValue=function(e,t,a,r){var n,i=t.replace("()","").split("."),p=e;i.forEach(function(e,t){if(e===a&&0===t)return n=e;t<i.length&&(n=e),t<i.length-1&&(p=p[e])}),n&&(p[n]=r)},t.prototype._getVMVal=function(e,t){var a=t.replace("()","").split("."),r=e;return a.forEach(function(e){"this"!==e&&(r=r[e])}),r},t.prototype._getVMRepeatVal=function(e,t,a){var r;return t.replace("()","").split(".").forEach(function(t,n){r=t!==a||0!==n?r[t]:e}),r},t.prototype.bind=function(e,t,a,r,n,i,p,o){var s,l;s=0===n.indexOf(a)||0===n.indexOf(a+".")?this._getVMRepeatVal(t,n,a):this._getVMVal(p,n),l=0===n.indexOf(a)||0===n.indexOf(a+".")?o:this._getVMVal(p,n),e.hasChildNodes()||this.templateUpdater(e,t,a,p);var u=this[r+"Updater"];switch(r){case"model":u&&u.call(this,e,s,n,a,i,l,p);break;default:u&&u.call(this,e,s)}},t.prototype.templateUpdater=function(e,t,a,r){var n=e.textContent;if(/\{\{(.*)\}\}/g.test(n)){var i=RegExp.$1,p=void 0;p=0===i.indexOf(a)||0===i.indexOf(a+".")?this._getVMRepeatVal(t,i,a):this._getVMVal(r,i),e.textContent=e.textContent.replace(/(\{\{.*\}\})/g,p)}},t.prototype.textUpdater=function(e,t){e.textContent=void 0===t?"":t},t.prototype.htmlUpdater=function(e,t){e.innerHTML=void 0===t?"":t},t.prototype.ifUpdater=function(e,t){t&&this.$fragment.appendChild(e)},t.prototype.classUpdater=function(e,t,a){var r=e.className,n=(r=r.replace(a,"").replace(/\s$/,""))&&String(t)?" ":"";e.className=r+n+t},t.prototype.modelUpdater=function(t,a,r,n,i,p,o){t.value=void 0===a?"":a;var s=this,l=function(t){if(t.preventDefault(),/(this.state.).*/.test(r)){var a=r.replace(/(this.state.)|(this.props)/,"");if(t.target.value===p)return;o.state[a]=t.target.value}if(/(this.props.).*/.test(r)){a=r.replace(/(this.state.)|(this.props)/,"");if(t.target.value===p)return;o.props[a]=t.target.value}if((0===r.indexOf(n)||0===r.indexOf(n+"."))&&("object"!==e(p[i])&&(p[i]=t.target.value),"object"===e(p[i]))){var l=s._getValueByValue(p[i],r,n);l=t.target.value,s._setValueByValue(p[i],r,n,l)}};if(t.addEventListener("input",l,!1),t.eventinput=l,t.eventTypes){var u=JSON.parse(t.eventTypes);u.push("input"),t.eventTypes=u}t.eventTypes||(t.eventTypes=JSON.stringify(["input"]))},t.prototype.eventHandler=function(e,t,a,r,n,i){var p=r.split(":")[1],o=a.replace(/\(.*\)/,"").split("."),s=a.match(/\((.*)\)/)[1].replace(/ /g,"").split(","),l=t;o.forEach(function(e){"this"!==e&&(l=l[e])});var u=this,f=function(e){var a=this,r=[];s.forEach(function(p){return""!==p&&("$event"===p?r.push(e):/(this.).*/g.test(p)||/(this.state.).*/g.test(p)||/(this.props.).*/g.test(p)?r.push(u._getVMVal(t,p)):/\'.*\'/g.test(p)?r.push(p.match(/\'(.*)\'/)[1]):!/\'.*\'/g.test(p)&&/^[0-9]*$/g.test(p)?r.push(Number(p)):"true"===p||"false"===p?r.push("true"===p):0===p.indexOf(n)||0===p.indexOf(n+".")?r.push(u._getVMRepeatVal(i,p,n)):void(a.repeatData&&Object.keys(a.repeatData).forEach(function(e){if(0===p.indexOf(e)||0===p.indexOf(e+"."))return r.push(u._getValueByValue(a.repeatData[e],p,e))})))}),l.apply(t,r)};if(p&&l){if(e["on"+p]=f,e["event"+p]=f,e.eventTypes){var c=JSON.parse(e.eventTypes);c.push(p),e.eventTypes=c}e.eventTypes||(e.eventTypes=JSON.stringify([p]))}},t}();exports.CompileUtilForRepeat=t;var a=function(){function e(e){this.$fragment=e}return e.prototype._getValueByValue=function(e,t,a){var r=t.replace("()","").split("."),n=e;return r.forEach(function(e,t){e===a&&0===t||(n=n[e])}),n},e.prototype._getVMVal=function(e,t){var a=t.replace("()","").split("."),r=e;return a.forEach(function(e,t){"this"===e&&0===t||(r=r[e])}),r},e.prototype._getVMRepeatVal=function(e,t){var a=t.split(" ");return this._getVMVal(e,a[3])},e.prototype.bind=function(e,t,a,r){var n=this[r+"Updater"];if(this.isRepeatNode(e))switch(r){case"repeat":n&&n.call(this,e,this._getVMRepeatVal(t,a),a,t)}else switch(r){case"model":n&&n.call(this,e,this._getVMVal(t,a),a,t);break;case"text":n&&n.call(this,e,this._getVMVal(t,a));break;case"if":n&&n.call(this,e,this._getVMVal(t,a),a,t);break;default:n&&n.call(this,e,this._getVMVal(t,a))}},e.prototype.templateUpdater=function(e,t,a){e.textContent=e.textContent.replace(/(\{\{.*\}\})/g,this._getVMVal(t,a))},e.prototype.textUpdater=function(e,t){e.textContent=void 0===t?"":t},e.prototype.htmlUpdater=function(e,t){e.innerHTML=void 0===t?"":t},e.prototype.ifUpdater=function(e,t){!t&&this.$fragment.contains(e)?this.$fragment.removeChild(e):this.$fragment.appendChild(e)},e.prototype.classUpdater=function(e,t,a){var r=e.className,n=(r=r.replace(a,"").replace(/\s$/,""))&&String(t)?" ":"";e.className=r+n+t},e.prototype.modelUpdater=function(e,t,a,r){e.value=void 0===t?"":t;var n=a.replace(/(this.state.)|(this.props)/,""),i=function(e){e.preventDefault(),/(this.state.).*/.test(a)&&(r.state[n]=e.target.value),/(this.props.).*/.test(a)&&(r.props[n]=e.target.value)};if(e.addEventListener("input",i,!1),e.eventinput=i,e.eventTypes){var p=JSON.parse(e.eventTypes);p.push("input"),e.eventTypes=p}e.eventTypes||(e.eventTypes=JSON.stringify(["input"]))},e.prototype.repeatUpdater=function(e,a,r,n){var i=this,p=r.split(" ")[1];a.forEach(function(o,s){var l={};l[p]=o,l.$index=s;var u=i.cloneNode(e,l),f=u.attributes,c=u.textContent;/\{\{(.*)\}\}/g.test(c)&&c.indexOf("{{"+p)>=0&&!u.hasChildNodes()&&new t(i.$fragment).templateUpdater(u,o,p,n),f&&Array.from(f).forEach(function(e){var r=e.name;if(i.isDirective(r)&&"es-repeat"!==r){var l=r.substring(3),f=e.value;i.isEventDirective(l)?new t(i.$fragment).eventHandler(u,n,f,l,p,o):new t(i.$fragment).bind(u,o,p,l,f,s,n,a)}}),i.isIfNode(e)||i.$fragment.appendChild(u),u.hasChildNodes()&&i.repeatChildrenUpdater(u,o,r,s,n,a)})},e.prototype.repeatChildrenUpdater=function(a,r,n,i,p,o){var s=this,l=n.split(" ")[1];Array.from(a.childNodes).forEach(function(u){a.repeatData&&(u.repeatData=Object.assign({},a.repeatData)),a.repeatData||(u.repeatData={}),u.repeatData[l]=r,u.repeatData.$index=i,s.isRepeatProp(u)&&u.setAttribute("_prop-"+l,JSON.stringify(r));var f=u.attributes,c=u.textContent,v=!0;/\{\{(.*)\}\}/g.test(c)&&c.indexOf("{{"+l)>=0&&!u.hasChildNodes()&&new t(a).templateUpdater(u,r,l,p),f&&Array.from(f).forEach(function(e){var n=e.name,f=e.value,c=n.substring(3),h=new t;s.isDirective(n)&&"es-repeat"!==n&&new RegExp("(^"+l+")|(^this)").test(f)&&(s.isEventDirective(c)?new t(a).eventHandler(u,p,f,c,l,r):new t(a).bind(u,r,l,c,f,i,p,o),"if"===c&&new RegExp("(^"+l+")").test(f)&&(v=h._getVMRepeatVal(r,f,l)),"if"===c&&/^(this\.)/.test(f)&&(v=h._getVMVal(p,f)),u.removeAttribute(n))}),u.hasChildNodes()&&!s.isRepeatNode(u)&&s.repeatChildrenUpdater(u,r,n,i,p,o),!v&&a.contains(u)&&a.removeChild(u);var h=u.attributes;if(h&&v){var d=Array.from(h).find(function(e){return s.isDirective(e.name)&&"es-repeat"===e.name});if(d){var y=d.value.split(" ")[3];/^(this\.)/.test(y)&&(new e(a).bind(u,p,d.value,d.name.substring(3)),a.contains(u)&&a.removeChild(u)),new RegExp("(^"+l+")").test(y)&&(new e(a).repeatUpdater(u,s._getValueByValue(r,y,l),d.value,p),a.contains(u)&&a.removeChild(u))}}})},e.prototype.isDirective=function(e){return 0===e.indexOf("es-")},e.prototype.isEventDirective=function(e){return 0===e.indexOf("on")},e.prototype.isElementNode=function(e){return 1===e.nodeType},e.prototype.isRepeatNode=function(e){var t=e.attributes,a=!1;return t&&Array.from(t).forEach(function(e){"es-repeat"===e.name&&(a=!0)}),a},e.prototype.isIfNode=function(e){var t=e.attributes,a=!1;return t&&Array.from(t).forEach(function(e){"es-if"===e.name&&(a=!0)}),a},e.prototype.isRepeatProp=function(e){var t=e.attributes;return!!t&&!!Array.from(t).find(function(e){return/^\{(.+)\}$/.test(e.value)})},e.prototype.cloneNode=function(e,t){var a=e.cloneNode(!0);return e.eventTypes&&(JSON.parse(e.eventTypes).forEach(function(t){return a["on"+t]=e["event"+t]}),a.eventTypes=JSON.parse(JSON.stringify(e.eventTypes))),e.repeatData&&(a.repeatData=Object.assign({},t)),a},e}();exports.CompileUtil=a;
},{}],"twql":[function(require,module,exports) {
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var t=e(require("../VirtualDOM")),i=e(require("../Utils")),r=require("../CompileUtils"),n=function(){function e(e,r,n){if(this.utils=new i.default,this.$vm=r,this.$el=this.isElementNode(e)?e:document.querySelector(e),this.$el){if(this.$fragment=this.node2Fragment(this.$el),this.init(),n){var o=this.$fragment.querySelectorAll(this.$vm.$vm.$routeDOMKey)[0];o.parentNode.replaceChild(n,o)}var s=t.default.parseToVnode(this.$el),a=t.default.parseToVnode(this.$fragment),u=[];t.default.diffVnode(s,a,u),t.default.renderVnode(u),this.utils=null,this.$fragment=null,s=null,a=null,u=null}}return e.prototype.init=function(){this.compileElement(this.$fragment)},e.prototype.compileElement=function(e){var t=document.createElement("div");t.innerHTML=this.utils.formatInnerHTML(this.$vm.$template);var i=t.childNodes;this.recursiveDOM(i,e)},e.prototype.recursiveDOM=function(e,t){var i=this;Array.from(e).forEach(function(e){e.hasChildNodes()&&!i.isRepeatNode(e)&&i.recursiveDOM(e.childNodes,e);var r=e.textContent;if(i.isElementNode(e)){if(/\{\{(.*)\}\}/g.test(r)){var n=RegExp.$1;/(.*\{\{(this.).*\}\}.*)/g.test(r)&&i.compileText(e,n)}i.compile(e,t)}i.isRepeatNode(e)&&t.contains(e)?t.removeChild(e):i.isIfNode(e)||t.appendChild(e)})},e.prototype.compile=function(e,t){var i=this,n=e.attributes;n&&Array.from(n).forEach(function(n){var o=n.name;if(i.isDirective(o)){var s=o.substring(3),a=n.value;i.isEventDirective(s)?i.eventHandler(e,i.$vm,a,s):new r.CompileUtil(t).bind(e,i.$vm,a,s)}})},e.prototype.node2Fragment=function(e){return document.createDocumentFragment()},e.prototype.compileText=function(e,t){new r.CompileUtil(this.$fragment).templateUpdater(e,this.$vm,t)},e.prototype.eventHandler=function(e,t,i,n){var o=n.split(":")[1],s=i.replace(/\(.*\)/,"").split("."),a=i.match(/\((.*)\)/)[1].replace(/\s+/g,"").split(","),u=t;s.forEach(function(e){"this"!==e&&(u=u[e])});var p=function(e){var i=[];a.forEach(function(n){if(""===n)return!1;"$event"===n&&i.push(e),(/(this.).*/g.test(n)||/(this.state.).*/g.test(n)||/(this.props.).*/g.test(n))&&i.push((new r.CompileUtil)._getVMVal(t,n)),/\'.*\'/g.test(n)&&i.push(n.match(/\'(.*)\'/)[1]),!/\'.*\'/g.test(n)&&/^[0-9]*$/g.test(n)&&i.push(Number(n)),"true"!==n&&"false"!==n||i.push("true"===n)}),u.apply(t,i)};if(o&&u){if(e["on"+o]=p,e["event"+o]=p,e.eventTypes){var l=JSON.parse(e.eventTypes);l.push(o),e.eventTypes=l}e.eventTypes||(e.eventTypes=JSON.stringify([o]))}},e.prototype.isDirective=function(e){return 0===e.indexOf("es-")},e.prototype.isEventDirective=function(e){return 0===e.indexOf("on")},e.prototype.isElementNode=function(e){return"string"!=typeof e&&1===e.nodeType},e.prototype.isRepeatNode=function(e){var t=e.attributes,i=!1;return t&&Array.from(t).forEach(function(e){"es-repeat"===e.name&&(i=!0)}),i},e.prototype.isIfNode=function(e){var t=e.attributes,i=!1;return t&&Array.from(t).forEach(function(e){"es-if"===e.name&&(i=!0)}),i},e.prototype.isTextNode=function(e){return 3===e.nodeType},e}();exports.default=n;
...
"use strict";function e(e){var t=Reflect.getMetadata("design:paramtypes",e);t.length&&t.forEach(function(t,n){if(t===e)throw new Error("不可以依赖自身");var r=t.name;e._needInjectedClass?e._needInjectedClass.push(r):e._needInjectedClass=[r]})}function t(e,t){var r=[];if(e._needInjectedClass&&e._needInjectedClass.forEach(function(c){var s=e._injectedProviders.has(c)?e._injectedProviders.get(c):t.$providers.find(function(e){return e.constructor.name===c});s&&r.push(n(s,t))}),!e._needInjectedClass){e.toString().match(/^function\s+[^\(]*\(\s*([^\)]*)\)/m)[1].replace(/ /g,"").split(",").forEach(function(c){var s=c.replace(/\n/g,""),a=""+s.charAt(0).toUpperCase()+s.slice(1),o=e._injectedProviders.has(a)?e._injectedProviders.get(a):t.$providers.find(function(e){return e.constructor.name===a});o&&r.push(n(o,t))})}return r}function n(e,n){var r=t(e,n);return e.isSingletonMode&&e.getInstance(r),Reflect.construct(e,r)}Object.defineProperty(exports,"__esModule",{value:!0}),require("reflect-metadata"),exports.Injectable=e,exports.injector=t,exports.factoryCreator=n;
},{"reflect-metadata":"npqE"}],"7Ulo":[function(require,module,exports) {
"use strict";var t=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var e=t(require("../Compile")),o=t(require("../Watcher")),s=t(require("../Utils")),n=require("../CompileUtils"),r=require("../Injectable");function i(t){return function(i){var c=i.prototype;c.$template=t.template,c.state=t.state,c.utils=new s.default,c.compileUtil=new n.CompileUtil,c.$components={},c.$componentList=[],c.$getLocation=function(){return{path:this.$vm.$esRouteObject.path,query:this.$vm.$esRouteObject.query,params:this.$vm.$esRouteObject.params}},c.$setLocation=function(t,e,o){var s="/"===this.$vm.$rootPath?"":this.$vm.$rootPath;history.pushState({path:t,query:e,params:o},null,""+s+t+this.utils.buildQuery(e)),this.$vm.$esRouteObject={path:t,query:e,params:o}},c.$beforeInit=function(){this.props&&(this.propsWatcher=new o.default(this.props,this.esWatchState.bind(this),this.$reRender.bind(this))),this.stateWatcher=new o.default(this.state,this.esWatchState.bind(this),this.$reRender.bind(this))},c.$render=function(){var t=this.$renderDom;new e.default(t,this);this.$mountComponent(t,!0),this.$componentList.forEach(function(t){t.scope.$render&&t.scope.$render(),t.scope.esAfterMount&&t.scope.esAfterMount()}),this.esHasRender&&this.esHasRender()},c.esWatchState=function(t,e){},c.$reRender=function(){var t=this.$renderDom,o=t.querySelectorAll(this.$vm.$routeDOMKey)[0];new e.default(t,this,o);this.$mountComponent(t,!1),this.$componentList.forEach(function(t){t.scope.$render&&t.scope.$reRender(),t.scope.esAfterMount&&t.scope.esAfterMount()}),this.esHasRender&&this.esHasRender()},c.$mountComponent=function(t,e){var o=this,s=[];this.$componentList.forEach(function(t){s.push(t)}),this.$componentsConstructor(t),this.$componentList.forEach(function(t){var n=s.find(function(e){return e.dom===t.dom});n&&(t.scope=n.scope,t.scope.props=t.props),t.scope.$vm=o.$vm,t.scope.$components=o.$components,t.scope.$beforeInit&&t.scope.$beforeInit(),t.scope.esOnInit&&e&&t.scope.esOnInit(),t.scope.esBeforeMount&&t.scope.esBeforeMount()})},c.$componentsConstructor=function(t){var e=this;this.$componentList=[];var o=t.querySelectorAll(this.$vm.$routeDOMKey)[0];for(var s in this.constructor._injectedComponents)this.$components[s]=this.constructor._injectedComponents[s];var n=function(s){var n=t.getElementsByTagName(s);Array.from(n).forEach(function(t){if(!o||!o.contains(t)){var n=t.attributes,r={};if(n){var i=Array.from(n),c={};i.forEach(function(t){/^\_prop\-(.+)/.test(t.name)&&(c[t.name.replace("_prop-","")]=JSON.parse(t.value))}),i.forEach(function(o){var s=o.name,n=/^\{(.+)\}$/.exec(o.value);if(n){var i=n[1].split("."),a=i[0],p=null;/^(this.).*/g.test(n[1])&&(p=e.compileUtil._getVMVal(e,n[1])),c.hasOwnProperty(a)&&(p=e.getPropsValue(i,c[a])),r[s]=e.buildProps(p)}t.removeAttribute(s)})}e.$componentList.push({dom:t,props:r,scope:e.buildComponentScope(e.$components[s],r,t)})}})};for(var s in this.$components)n(s)},c.$setState=function(t){if(t&&this.utils.isFunction(t)){var e=t();if(e&&e instanceof Object)for(var o in e)this.state.hasOwnProperty(o)&&this.state[o]!==e[o]&&(this.state[o]=e[o])}if(t&&t instanceof Object)for(var o in t)this.state.hasOwnProperty(o)&&this.state[o]!==t[o]&&(this.state[o]=t[o])},c.$setProps=function(t){if(t&&this.utils.isFunction(t)){var e=t();if(e&&e instanceof Object)for(var o in e)this.props.hasOwnProperty(o)&&this.props[o]!==e[o]&&(this.props[o]=e[o])}if(t&&t instanceof Object)for(var o in t)this.props.hasOwnProperty(o)&&this.props[o]!==t[o]&&(this.props[o]=t[o])},c.getPropsValue=function(t,e){var o=e;return t.forEach(function(t,e){0!==e&&(o=o[t])}),o},c.buildProps=function(t){return this.utils.isFunction(t)?t.bind(this):t},c.buildComponentScope=function(t,e,o){var s=r.factoryCreator(t,this.$vm.$rootModule);return s.props=e,s.$renderDom=o,s.$components=this.$components,s}}}exports.default=i;
},{"../Compile":"twql","../Watcher":"w9Fr","../Utils":"H8Ea","../CompileUtils":"bsu5","../Injectable":"tZRA"}],"JJ5c":[function(require,module,exports) {
"use strict";var t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},e=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{default:t}};Object.defineProperty(exports,"__esModule",{value:!0});var r=e(require("../Utils")),o=e(require("../KeyWatcher")),n=function(){function e(){this.routes=[],this.routesList=[],this.currentUrl="",this.lastRoute=null,this.rootDom=null,this.utils=new r.default,this.$rootPath="/",this.hasRenderComponentList=[],this.needRedirectPath=null,this.$vm=null,this.watcher=null,this.renderRouteList=[]}return e.prototype.$bootstrap=function(t){var e=this;this.$vm=t,this.$vm.$setRootPath(this.$rootPath),this.$vm.$canRenderModule=!1,this.$vm.$routeDOMKey="router-render",window.addEventListener("load",this.refresh.bind(this),!1),window.addEventListener("popstate",function(t){var r;r="/"===e.$rootPath?location.pathname||"/":""===location.pathname.replace(e.$rootPath,"")?"/":location.pathname.replace(e.$rootPath,""),e.$vm.$esRouteObject={path:r,query:{},params:{}}},!1)},e.prototype.$init=function(t){if(t&&t instanceof Array){var e=document.querySelector("#root");this.rootDom=e||null,this.routes=t,this.routesList=[]}else console.error("no routes exit")},e.prototype.$setRootPath=function(t){t&&"string"==typeof t?this.$rootPath=t:console.error("rootPath is not defined or rootPath must be a String")},e.prototype.$routeChange=function(t,e){},e.prototype.redirectTo=function(t){var e="/"===this.$rootPath?"":this.$rootPath;history.replaceState(null,null,""+e+t),this.$vm.$esRouteObject={path:t||"/",query:{},params:{}}},e.prototype.refresh=function(){if(!this.$vm.$esRouteObject||!this.watcher){var t=void 0;t="/"===this.$rootPath?location.pathname||"/":""===location.pathname.replace(this.$rootPath,"")?"/":location.pathname.replace(this.$rootPath,""),this.$vm.$esRouteObject={path:t,query:{},params:{}},this.watcher=new o.default(this.$vm,"$esRouteObject",this.refresh.bind(this))}this.currentUrl=this.$vm.$esRouteObject.path||"/",this.routesList=[],this.renderRouteList="/"===this.currentUrl?["/"]:this.currentUrl.split("/"),this.renderRouteList[0]="/",this.distributeRoutes()},e.prototype.distributeRoutes=function(){this.lastRoute&&this.lastRoute!==this.currentUrl?this.insertRenderRoutes():this.generalDistributeRoutes(),this.$routeChange(this.lastRoute,this.currentUrl),this.lastRoute=this.currentUrl,this.needRedirectPath&&(this.redirectTo(this.needRedirectPath),this.needRedirectPath=null)},e.prototype.insertRenderRoutes=function(){var e=this,r="/"===this.lastRoute?["/"]:this.lastRoute.split("/");r[0]="/";for(var o=function(t){var o=n.renderRouteList[t];if(0===t){var s=n.routes.find(function(t){return t.path===""+o||/^\/\:.+/.test(t.path)});if(!s)return console.error("wrong route instantiation in insertRenderRoutes:",n.currentUrl),{value:void 0};n.routesList.push(s)}else{var i=n.routesList[t-1].children;if(!(i&&i instanceof Array))return console.error("routes not exit or routes must be an array!"),{value:void 0};var u=i.find(function(t){return t.path==="/"+o||/^\/\:.+/.test(t.path)});if(!u)return console.error("wrong route instantiation1:",n.currentUrl),{value:void 0};n.routesList.push(u)}if(o!==r[t]){var a=n.hasRenderComponentList[t];a&&a.esOnDestory&&a.esOnDestory();var h=n.routesList[t];if(!h)return console.error("wrong route instantiation in insertRenderRoutes:",n.currentUrl),{value:void 0};if(h.redirectTo&&/^\/.*/.test(h.redirectTo)&&t+1===n.renderRouteList.length)return n.hasRenderComponentList.forEach(function(r,o){r.esRouteChange&&r.esRouteChange(e.lastRoute,e.currentUrl),o>t&&r.esOnDestory&&r.esOnDestory()}),n.hasRenderComponentList.length=t,n.needRedirectPath=h.redirectTo,{value:void 0};var c=n.$vm.$components[h.component],l=document.querySelectorAll("router-render")[t-1];n.hasRenderComponentList.forEach(function(r,o){r.esRouteChange&&r.esRouteChange(e.lastRoute,e.currentUrl),o>t&&r.esOnDestory&&r.esOnDestory()}),n.hasRenderComponentList.length=t,n.instantiateComponent(c,l).then(function(r){e.hasRenderComponentList[t]=r})}if(t===n.renderRouteList.length-1&&t<r.length-1){l=document.querySelectorAll("router-render")[t];n.hasRenderComponentList.forEach(function(r,o){r.esRouteChange&&r.esRouteChange(e.lastRoute,e.currentUrl),o>t&&r.esOnDestory&&r.esOnDestory()}),l&&l.hasChildNodes()&&l.removeChild(l.childNodes[0]),n.hasRenderComponentList.length=t}},n=this,s=0;s<this.renderRouteList.length;s++){var i=o(s);if("object"===(void 0===i?"undefined":t(i)))return i.value}},e.prototype.generalDistributeRoutes=function(){for(var e=this,r=function(t){var r=o.renderRouteList[t];if(0===t){var n=o.routes.find(function(t){return t.path===""+r||/^\/\:.+/.test(t.path)});if(!n)return console.error("wrong route instantiation in generalDistributeRoutes:",o.currentUrl),{value:void 0};var s=null;if(!o.$vm.$rootModule.$components[n.component])return console.error("route error: "+n.component+" is undefined"),{value:void 0};s=o.$vm.$components[n.component];var i=document.querySelector("#root");if(o.routesList.push(n),o.instantiateComponent(s,i).then(function(r){e.hasRenderComponentList[t]=r}).catch(function(){return console.error("renderComponent failed")}),o.hasRenderComponentList.forEach(function(r,o){r.esRouteChange&&r.esRouteChange(e.lastRoute,e.currentUrl),o>t&&r.esOnDestory&&r.esOnDestory()}),n.redirectTo&&/^\/.*/.test(n.redirectTo)&&t+1===o.renderRouteList.length)return o.needRedirectPath=n.redirectTo,o.hasRenderComponentList.length=t,{value:void 0}}else{var u=o.routesList[t-1].children;u&&u instanceof Array||console.error("routes not exit or routes must be an array!");var a=u.find(function(t){return t.path==="/"+r||/^\/\:.+/.test(t.path)});if(!a)return console.error("wrong route instantiation1:",o.currentUrl),{value:void 0};if(a.redirectTo&&/^\/.*/.test(a.redirectTo)&&t+1===o.renderRouteList.length)return o.hasRenderComponentList.forEach(function(r,o){r.esRouteChange&&r.esRouteChange(e.lastRoute,e.currentUrl),o>t&&r.esOnDestory&&r.esOnDestory()}),o.needRedirectPath=a.redirectTo,o.hasRenderComponentList.length=t,{value:void 0};s=null;if(!o.$vm.$rootModule.$components[a.component])return console.error("route error: "+a.component+" is undefined"),{value:void 0};s=o.$vm.$components[a.component];var h=document.querySelectorAll("router-render")[t-1];o.routesList.push(a),o.hasRenderComponentList.forEach(function(t){t.esRouteChange&&t.esRouteChange(e.lastRoute,e.currentUrl)}),o.instantiateComponent(s,h).then(function(r){e.hasRenderComponentList[t]=r}).catch(function(){return console.error("renderComponent failed")})}},o=this,n=0;n<this.renderRouteList.length;n++){var s=r(n);if("object"===(void 0===s?"undefined":t(s)))return s.value}},e.prototype.instantiateComponent=function(t,e){return this.$vm.$renderComponent(t,e)},e}();exports.default=n;
},{"../Utils":"H8Ea","../KeyWatcher":"9pTu"}],"af3V":[function(require,module,exports) {
"use strict";var o=this&&this.__importDefault||function(o){return o&&o.__esModule?o:{default:o}};Object.defineProperty(exports,"__esModule",{value:!0});var t=o(require("../Utils"));function r(o){return function(r){var i=r.prototype;i.$exportList={},i.providerList=new Map,i.utils=new t.default,o.imports&&(i.$imports=o.imports),o.components&&(i.$components=o.components),o.providers&&(i.$providers=o.providers),o.exports&&(i.$exports=o.exports),o.bootstrap&&(i.$bootstrap=o.bootstrap),i.$buildImports=function(){var o=this;this.$imports&&this.$imports.forEach(function(t){var r=e(t);for(var i in r.$exportList)o.$components[i]=r.$exportList[i]})},i.$buildProviderList=function(){var o=this;this.$providers&&this.$providers.forEach(function(t){return o.providerList.set(""+t.name.charAt(0).toUpperCase()+t.name.slice(1),t)})},i.$buildProviders4Services=function(){if(this.$providers){var o=function(o){var r=t.$providers[o];r._injectedProviders?t.providerList.forEach(function(o,t){r._injectedProviders.has(t)||r._injectedProviders.set(t,o)}):r._injectedProviders=t.providerList},t=this;for(var r in this.$providers)o(r)}},i.$buildProviders4Components=function(){if(this.$providers){var o=function(o){var r=t.$components[o];r._injectedProviders?t.providerList.forEach(function(o,t){r._injectedProviders.has(t)||r._injectedProviders.set(t,o)}):r._injectedProviders=t.providerList},t=this;for(var r in this.$components)o(r)}},i.$buildComponents4Components=function(){if(this.$components)for(var o in this.$components){var t=this.$components[o];t._injectedComponents?t._injectedComponents=Object.assign(t._injectedComponents,this.$components):t._injectedComponents=this.$components}},i.$buildExports=function(){var o=this;this.$exports&&this.$exports.forEach(function(t){o.$components[t]&&(o.$exportList[t]=o.$components[t])})}}}function e(o){var t=new o;return t.$buildImports(),t.$buildProviderList(),t.$buildProviders4Services(),t.$buildComponents4Components(),t.$buildProviders4Components(),t.$buildExports(),t}exports.EsModule=r,exports.factoryModule=e;
},{"../Utils":"H8Ea"}],"2IHI":[function(require,module,exports) {
"use strict";var o=this&&this.__importDefault||function(o){return o&&o.__esModule?o:{default:o}};Object.defineProperty(exports,"__esModule",{value:!0});var t=o(require("../Utils")),e=require("../Injectable"),r=require("../EsModule"),s=function(){function o(){this.modalList=[],this.utils=new t.default,this.rootDom=document.querySelector("#root"),this.$rootPath="/",this.$canRenderModule=!0,this.$routeDOMKey="router-render",this.$rootModule=null,this.$esRouteObject=null}return o.prototype.$use=function(o){var t=this;return o.$bootstrap(this),this.modalList.push(o),this.modalList.findIndex(function(e){return t.utils.isEqual(e,o)})},o.prototype.$setRootPath=function(o){o&&"string"==typeof o?this.$rootPath=o:console.error("rootPath is not defined or rootPath must be a String")},o.prototype.$bootstrapModule=function(o){o?(this.$rootModule=r.factoryModule(o),this.$components=Object.assign({},this.$rootModule.$components)):console.error("must send a root module")},o.prototype.$init=function(){this.$rootModule?this.$canRenderModule&&this.$renderModuleBootstrap():console.error("must use $bootstrapModule to declare a root EsModule before $init")},o.prototype.$renderModuleBootstrap=function(){if(this.$rootModule.$bootstrap){var o=this.$rootModule.$bootstrap;this.$renderComponent(o,this.rootDom)}else console.error("need $bootstrap for render Module Bootstrap")},o.prototype.$renderComponent=function(o,t){var r=e.factoryCreator(o,this.$rootModule);if(r.$vm=this,r.$components=this.$rootModule.$components,r.$beforeInit&&r.$beforeInit(),r.esOnInit&&r.esOnInit(),r.$template){var s=r.$template;return s&&"string"==typeof s&&t?(r.esBeforeMount&&r.esBeforeMount(),this.replaceDom(r,t).then(function(){r.esAfterMount&&r.esAfterMount()}),Promise.resolve(r)):(console.error("renderBootstrap failed: template or rootDom is not exit"),Promise.reject())}console.error("must decaler this.$template in $bootstrap()")},o.prototype.replaceDom=function(o,t){return o.$renderDom=t,o.$render?(o.$render(),Promise.resolve()):Promise.reject()},o}();exports.default=s;
},{"../Utils":"H8Ea","../Injectable":"tZRA","../EsModule":"af3V"}],"ezG2":[function(require,module,exports) {
"use strict";function e(e){return function(t){e&&e.isSingletonMode&&(t.isSingletonMode=e.isSingletonMode),t.instance=null,t._injectedProviders=new Map,t.getInstance=function(e){return this.isSingletonMode?this.isSingletonMode?(this.instance||(this.instance=Reflect.construct(this,e)),this.instance):void 0:Reflect.construct(this,e)}}}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=e;
...
var IntroductionContainer = /** @class */function () {
    ...
    IntroductionContainer = __decorate([easiest_1.Component({
        state: {
...
var ArchitectureContainer = /** @class */function () {
    ...
    ArchitectureContainer = __decorate([easiest_1.Component({
        state: {
...
var SideBar = /** @class */function () {
    ...
    SideBar = __decorate([easiest_1.Component({
        state: {
            navs: nav_1.navs
        },
