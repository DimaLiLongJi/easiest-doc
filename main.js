...
//# sourceMappingURL=data:application/json;base64,
...
var CompileUtilForRepeat = /** @class */function () {
    ...
    CompileUtilForRepeat.prototype.modelUpdater = function (node, value, exp, key, index, watchData, vm) {
        ...
        var func = function func(event) {
            ...
            if (/(this.props.).*/.test(exp)) {
                var val = exp.replace(/(this.state.)|(this.props)/, '');
                if (event.target.value === watchData) return;
                vm.props[val] = event.target.value;
            }
            if (exp.indexOf(key) === 0 || exp.indexOf(key + ".") === 0) {
    ...
    CompileUtilForRepeat.prototype.eventHandler = function (node, vm, exp, eventName, key, val) {
        ...
        var args = exp.match(/\((.*)\)/)[1].replace(/ /g, '').split(',');
        var fn = vm;
        ...
        Array.from(node.childNodes).forEach(function (child) {
            ...
            if (nodeAttrs) {
                Array.from(nodeAttrs).forEach(function (attr) {
                    ...
                    if (_this.isDirective(attrName) && attrName !== 'es-repeat' && new RegExp("(^" + key + ")|(^this)").test(exp)) {
                        if (_this.isEventDirective(dir)) {
...
//# sourceMappingURL=data:application/json;base64,
...
var Compile = /** @class */function () {
        ...
        Array.from(childNodes).forEach(function (node) {
            ...
            if (_this.isElementNode(node)) {
                if (reg.test(text)) {
                    ...
                    if (/(.*\{\{(this.).*\}\}.*)/g.test(text)) _this.compileText(node, regText);
                }
    ...
    Compile.prototype.eventHandler = function (node, vm, exp, eventName) {
        var eventType = eventName.split(':')[1];
        var fnList = exp.replace(/\(.*\)/, '').split('.');
        var args = exp.match(/\((.*)\)/)[1].replace(/\s+/g, '').split(',');
        var fn = vm;
        fnList.forEach(function (f) {
            if (f === 'this') return;
            fn = fn[f];
        ...
        var func = function func(event) {
            ...
            args.forEach(function (arg) {
                ...
                if (/(this.).*/g.test(arg) || /(this.state.).*/g.test(arg) || /(this.props.).*/g.test(arg)) argsList.push(new CompileUtils_1.CompileUtil()._getVMVal(vm, arg));
...
//# sourceMappingURL=data:application/json;base64,
...
},{"reflect-metadata":"../../easiest/node_modules/reflect-metadata/Reflect.js"}],"../../easiest/src/Immutable/index.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../../easiest/src/Component/index.ts":[function(require,module,exports) {
"use strict";
        ...
        vm.$beforeInit = function () {
            if (this.props) {
                for (var key in this.props) {
                    Immutable_1.toImmutable(this.props[key]);
                }
            ...
            if (this.state) {
                for (var key in this.state) {
                    Immutable_1.toImmutable(this.state[key]);
                }
                    ...
                    if (nodeAttrs) {
                        ...
                        attrList.forEach(function (attr) {
                            ...
                            if (prop) {
                                ...
                                var key = valueList[0];
                                var _prop = null;
                                if (/^(this.).*/g.test(prop[1])) _prop = _this.compileUtil._getVMVal(_this, prop[1]);
            ...
            if (newProps && this.utils.isFunction(newProps)) {
                ...
                if (_newProps && _newProps instanceof Object) {
                    for (var key in _newProps) {
                        ...
                        if (this.props.hasOwnProperty(key) && this.props[key] !== _newProps[key]) {
                            this.props[key] = _newProps[key];
                            this.$reRender();
                        }
                    }
                }
...
//# sourceMappingURL=data:application/json;base64,
},{"../Compile":"../../easiest/src/Compile/index.ts","../Utils":"../../easiest/src/Utils/index.ts","../CompileUtils":"../../easiest/src/CompileUtils/index.ts","../Injectable":"../../easiest/src/Injectable/index.ts","../Immutable":"../../easiest/src/Immutable/index.ts"}],"../../easiest/src/Router/index.ts":[function(require,module,exports) {
"use strict";
...
var Router = /** @class */function () {
    ...
    Router.prototype.insertRenderRoutes = function () {
        ...
        var _loop_1 = function _loop_1(index) {
            ...
            if (index === 0) {
                ...
                if (!rootRoute) {
                    console.error('wrong route instantiation in insertRenderRoutes:', this_1.currentUrl);
                    return { value: void 0 };
                }
                ...
                if (!route) {
                    console.error('wrong route instantiation1:', this_1.currentUrl);
                    return { value: void 0 };
                }
    ...
    Router.prototype.generalDistributeRoutes = function () {
        ...
        var _loop_2 = function _loop_2(index) {
            ...
            if (index === 0) {
                ...
                if (!rootRoute) {
                    console.error('wrong route instantiation in generalDistributeRoutes:', this_2.currentUrl);
                    return { value: void 0 };
                }
                ...
                if (!route) {
                    console.error('wrong route instantiation1:', this_2.currentUrl);
                    return { value: void 0 };
                }
    ...
    // public async instantiateComponent(FindComponent: Function, renderDom: Element): Promise<any> {
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
...
//# sourceMappingURL=data:application/json;base64,
},{"./style.less":"pages/docs/component/style.less","../../../../../easiest/src":"../../easiest/src/index.ts"}],"modules/docs.ts":[function(require,module,exports) {
"use strict";
...
var SideBar = /** @class */function () {
    ...
    SideBar.prototype.goTo = function (to, index) {
        if (index || index === 0) {
            var navs_1 = JSON.parse(JSON.stringify(this.state.navs));
            navs_1.forEach(function (nav) {
                return nav.active = null;
            });
            navs_1[index].active = 'active';
            this.$setState({
                navs: navs_1
            });
        }
...
//# sourceMappingURL=data:application/json;base64,
